...
export const api = {
  ...
  courses: {
    ...
    listLanding: coursesService.listLandingCourses.bind(coursesService),
    getLandingDetail: coursesService.getLandingCourseDetail.bind(coursesService),
    createLanding: coursesService.createLandingCourse.bind(coursesService),
    updateLanding: coursesService.updateLandingCourse.bind(coursesService),
    deleteLanding: coursesService.deleteLandingCourse.bind(coursesService),
    listLandingBlogs: coursesService.listLandingBlogs.bind(coursesService),
    getLandingBlogDetail: coursesService.getLandingBlogDetail.bind(coursesService),
    createLandingBlog: coursesService.createLandingBlog.bind(coursesService),
    updateLandingBlog: coursesService.updateLandingBlog.bind(coursesService),
    deleteLandingBlog: coursesService.deleteLandingBlog.bind(coursesService),
    listLandingProjects: coursesService.listLandingProjects.bind(coursesService),
    getLandingProjectDetail: coursesService.getLandingProjectDetail.bind(coursesService),
    createLandingProject: coursesService.createLandingProject.bind(coursesService),
    updateLandingProject: coursesService.updateLandingProject.bind(coursesService),
    deleteLandingProject: coursesService.deleteLandingProject.bind(coursesService),
