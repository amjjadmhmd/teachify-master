          ...
          return (
            <Reveal key={course.id} delay={i * 0.1} width="100%">
              <div
                ...
                className={`group bg-white dark:bg-[#0F383D]/60 border border-slate-200 dark:border-white/10 rounded-2xl overflow-hidden shadow-lg hover:-translate-y-1 transition-all duration-300 flex flex-col h-full ${course.is_enrolled ? "cursor-pointer" : ""
                  }`}
              >
                  ...
                  <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
                    {(!course.is_enrolled) && (
                      <button
                        ...
                        className={`p-2 rounded-full transition-all ${addingToCart[course.id]
                    ...
                    <button
                      ...
                      className={`p-2 rounded-full hover:scale-110 transition-transform ${wishlistIds.includes(course.id)
                    ...
                    {!course.is_enrolled && (
                      <div className="flex items-center gap-2">
                        ...
                        <Button
                          ...
                          className={`!py-2 !px-4 text-xs transition-colors ${isPendingForCourse(course.id) ? '!bg-yellow-600 hover:!bg-yellow-700' : ''
                            }`}
                        >
                          {addingToCart[course.id]
